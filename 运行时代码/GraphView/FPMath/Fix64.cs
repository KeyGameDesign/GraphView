...
public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64> {
    ...
    public static string CeilingToString(Fix64 value)
    {
        return Ceiling(value).ToString();
    }
   ...
   public static explicit operator Fix64(long value) {
    ...
    public static Fix64 GetTenThousandFix64(int _source)
    {
        Fix64 result = new Fix64(_source);
        result = result / 10000f;
        return result;
    }
...
public struct FixVector2
{
    ...
    public static FixVector2 Rotate(FixVector2 _sourceVec2, Fix64 _angle)
    {
        Fix64 x = _sourceVec2.x * Fix64.Cos(_angle) - _sourceVec2.y * Fix64.Sin(_angle);
        Fix64 y = _sourceVec2.x * Fix64.Sin(_angle) + _sourceVec2.y * Fix64.Cos(_angle);
        return new FixVector2(x, y);
    }
